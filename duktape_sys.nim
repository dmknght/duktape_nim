...
proc duk_pull*(ctx: DTContext; from_idx: duk_idx_t) {.stdcall,
    importc: "duk_pull", header: headerduktape.}
...
proc duk_push_literal_raw*(ctx: DTContext; str: cstring; len: duk_size_t): cstring {.
    stdcall, importc: "duk_push_literal_raw", header: headerduktape.}
proc duk_push_this*(ctx: DTContext) {.stdcall, importc: "duk_push_this",
                                        header: headerduktape.}
proc duk_push_new_target*(ctx: DTContext) {.stdcall,
    importc: "duk_push_new_target", header: headerduktape.}
...
proc duk_push_bare_array*(ctx: DTContext): duk_idx_t {.stdcall,
    importc: "duk_push_bare_array", header: headerduktape.}
...
proc duk_require_constructor_call*(ctx: DTContext) {.stdcall,
    importc: "duk_require_constructor_call", header: headerduktape.}
proc duk_require_constructable*(ctx: DTContext; idx: duk_idx_t) {.stdcall,
    importc: "duk_require_constructable", header: headerduktape.}
...
proc duk_to_stacktrace*(ctx: DTContext; idx: duk_idx_t): cstring {.stdcall,
    importc: "duk_to_stacktrace", header: headerduktape.}
proc duk_safe_to_stacktrace*(ctx: DTContext; idx: duk_idx_t): cstring {.stdcall,
    importc: "duk_safe_to_stacktrace", header: headerduktape.}
...
proc duk_cbor_encode*(ctx: DTContext; idx: duk_idx_t; encode_flags: duk_uint_t) {.
    stdcall, importc: "duk_cbor_encode", header: headerduktape.}
proc duk_cbor_decode*(ctx: DTContext; idx: duk_idx_t; decode_flags: duk_uint_t) {.
    stdcall, importc: "duk_cbor_decode", header: headerduktape.}
...
proc duk_get_prop_literal_raw*(ctx: DTContext; obj_idx: duk_idx_t; key: cstring;
                              key_len: duk_size_t): duk_bool_t {.stdcall,
    importc: "duk_get_prop_literal_raw", header: headerduktape.}
...
proc duk_put_prop_literal_raw*(ctx: DTContext; obj_idx: duk_idx_t; key: cstring;
                              key_len: duk_size_t): duk_bool_t {.stdcall,
    importc: "duk_put_prop_literal_raw", header: headerduktape.}
...
proc duk_del_prop_literal_raw*(ctx: DTContext; obj_idx: duk_idx_t; key: cstring;
                              key_len: duk_size_t): duk_bool_t {.stdcall,
    importc: "duk_del_prop_literal_raw", header: headerduktape.}
...
proc duk_has_prop_literal_raw*(ctx: DTContext; obj_idx: duk_idx_t; key: cstring;
                              key_len: duk_size_t): duk_bool_t {.stdcall,
    importc: "duk_has_prop_literal_raw", header: headerduktape.}
...
proc duk_get_global_literal_raw*(ctx: DTContext; key: cstring;
                                key_len: duk_size_t): duk_bool_t {.stdcall,
    importc: "duk_get_global_literal_raw", header: headerduktape.}
proc duk_get_global_heapptr*(ctx: DTContext; `ptr`: pointer): duk_bool_t {.
    stdcall, importc: "duk_get_global_heapptr", header: headerduktape.}
...
proc duk_put_global_literal_raw*(ctx: DTContext; key: cstring;
                                key_len: duk_size_t): duk_bool_t {.stdcall,
    importc: "duk_put_global_literal_raw", header: headerduktape.}
proc duk_put_global_heapptr*(ctx: DTContext; `ptr`: pointer): duk_bool_t {.
    stdcall, importc: "duk_put_global_heapptr", header: headerduktape.}
...
proc duk_random*(ctx: DTContext): duk_double_t {.stdcall, importc: "duk_random",
    header: headerduktape.}
